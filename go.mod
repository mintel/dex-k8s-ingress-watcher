module github.com/mintel/dex-k8s-ingress-watcher
...
require (
	...
	github.com/coreos/dex v2.10.0+incompatible
	github.com/etherlabsio/healthcheck v0.0.0-20190516102650-2b759a75f4be // indirect
